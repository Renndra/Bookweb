...
<head>
   ...
   <style>
.box {
    position: relative; /* Memastikan posisi tombol relative terhadap box */
    padding: 20px;
...
.close-btn {
    position: absolute; /* Memposisikan tombol dengan absolute di dalam box */
    top: 10px;
    right: 10px;
    font-size: 46px;
    color: red;
...
<section class="placed-orders">
   ...
   <div class="box-container">
    ...
    ?>
        <div class="box" id="order_<?php echo $order_id; ?>">
            ...
            <?php if ($fetch_orders['payment_status'] == 'completed') { ?>
               <button type="button" onclick="hideOrder('order_<?php echo $order_id; ?>')" class="fas fa-times-circle close-btn" style="color:red"></button>
            <?php } ?>
        </div>
    <?php
        }
